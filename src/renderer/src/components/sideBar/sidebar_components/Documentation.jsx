...
function Documentation() {
  ...
  return (
    <div className="flex w-full h-full dark:text-white font-poppins pt-10 pl-8">
      <div className="flex flex-col w-2/3 max-h-[86vh]">
        ...
        {doc === 'Usto' && (
          <div className="flex justify-center overflow-y-auto grow">
            <div className="w-11/12 text-center">
              <h1 className="text-3xl pb-10">Règlement intérieur USTO</h1>
              <ul className="list-disc text-xl">
                <li>
                  <strong>Article 76</strong>: A l'issue de la contre correction, la note obtenue
                  est comparée avec la note initiale. Dans le cas où la seconde note est inférieure
                  à la note initiale et que l'écart constaté est supérieur ou égal à trois points,
                  la note la plus basse sera retenue définitivement et l'étudiant sera traduit
                ...
                <li>
                  ...
                  <ul className="pl-4 pt-4 [&>li]:pb-3">
                    ...
                    <li>
                      Le conseil de discipline de l’Université est compétent pour l’étude des
                      recours.
                    </li>
                  </ul>
                </li>
                ...
                <li>
                  ...
                  <ul className="pl-4 pt-4 [&>li]:pb-3">
                    ...
                    <li>
                      ...
                      aux enseignements et aux examens ou leur boycott, le regroupement
                      perturbateur…
                    </li>
                    <li>
                      Le vol, l'abus de confiance et le détournement de biens de l'établissement,
                ...
                <li>
                  ...
                  telle par un conseil de discipline et qui ne figure pas aux articles 117 et 118,
                  est qualifiée d’infraction du premier ou du deuxième degré selon sa gravité et ses
                  conséquences sur la communauté universitaire. Le conseil de discipline étant juge.
                </li>
                <li>
                  <strong>Article 120:</strong> Toute infraction dûment constatée est portée par
                  écrit à la connaissance du responsable de la structure pédagogique compétente dans
                  les quarante-huit (48) heures qui suivent les faits.
                </li>
                <li>
                  <strong>Article 121 :</strong>Les sanctions applicables aux infractions du premier
                  degré sont fixées comme suit : -Avertissement verbal, -Avertissement écrit versé
                  au dossier pédagogique de l’étudiant, - Blâme versé au dossier pédagogique de
                  l’étudiant.
                </li>
                <li>
                  <strong>Article 122 :</strong>Les sanctions applicables aux infractions du
                  deuxième degré sont fixées comme suit : -Exclusion pour un semestre ou une année,
                  -Exclusion pour deux ans, -Exclusion définitive.
                </li>
                <li>
                  <strong>Article 123 :</strong>Les sanctions disciplinaires prononcées par les
                  conseils de discipline ne préjugent pas, par ailleurs, des poursuites prévues par
                ...
                <li>
                  <strong>Article 125 :</strong>Les travaux des Conseils de discipline sont régis
                  par l’arrêté n° 96 du 09 juin 1989.
                </li>
                <li>
                  <strong>Article 126 :</strong>La décision de sanction est : Notifiée à
                  l’intéressé. Inscrite à son dossier. Affichée dans l'établissement. Communiquée
                  aux Arrete14 Etablissement d’Enseignement Supérieur et à l’Office National des
                  Œuvres Universitaires dont relève l’étudiant si la sanction est l’exclusion d’au
                  moins une année. Communiquée au Vice-Rectorat chargé de la Formation Supérieure
                  des, premier et deuxième cycles, la Formation Continue et les Diplômes et la
                  Formation Supérieure de Graduation.
                </li>
                <li>
                  <strong>Article 127 :</strong>L’étudiant sanctionné peut adresser un recours ou
                  une demande de grâce auprès du Chef de l'établissement. Elle doit être formulée
                  par écrit, datée et signée par l’intéressé dans un délai de quinze jours suivant
                ...
                <li>
                  ...
                  Doyen ou Chef de Département) de l’instance pédagogique compétente saisit de
                  nouveau le conseil de discipline qui a statué sur l’affaire.
                </li>
                <li>
                ...
                <li>
                  <strong>Article 90 :</strong>Les étudiants doivent respecter les règles
                  élémentaires de tenue vestimentaire et de comportement sous peine de sanctions
                  prévues par le conseil de discipline et/ou la loi.
                </li>
                <li>
                  <strong>Article 143 :</strong>En plus des sanctions fixées à l’article 122 du
                  chapitre IV-7 pour les infractions du deuxième degré, sont considérées comme
                  telles : La suspension des activités des associations ou organisations
                  estudiantines agréées à l’Université (sa durée est déterminée par le Conseil de
                  discipline selon la gravité de l’infraction) La fermeture définitive du bureau de
                  l’association ou de l’organisation agréée en cas de faute grave ou de récidive des
                  infractions du premier degré.
                </li>
              </ul>
            </div>
            ...
            <div className="w-11/12 text-center">
              ...
              <ul className="list-disc text-xl">
                <li>
                  ...
                  discipline est composé de 5 membres permanents et 5 membres suppléants. Ces
                  derniers ne siègent qu'en cas d'absence des membres permanents. Il est composé du
                  directeur ou son représentant, trois enseignants titulaires et trois suppléants
                  désignés par le directeur après avis du conseil de direction, et un membre
                  titulaire et un membre suppléant représentant des étudiants.
                </li>
                <li>
                ...
                <li>
                  <strong>Article 7: </strong>Conflit de compétences: En cas de conflit de
                  compétences entre conseils de discipline d'une même université, la désignation du
                  conseil de discipline est faite par le conseil de discipline de l'université.
                </li>
                <li>
                ...
                <li>
                  ...
                  directeur de l'institut national d'enseignement supérieur procède s'il y a lieu à
                  la saisine du conseil de discipline dans un délai de 10 jours en fixant le jour de
                  la réunion de ce dernier qui doit être au maximum de 7 jours fermes après la
                  saisine.
                </li>
                <li>
                  <strong>Article 22: </strong>Convocation des membres du conseil de discipline: Le
                  recteur ou le directeur de l'INES ou le directeur de l'établissement supérieur ou
                  le directeur d'institut adresse une convocation aux membres du conseil de
                  discipline cinq (5) jours avant la tenue de la réunion. Les membres permanents
                  doivent signaler leur absence 48 heures à l'avance, lorsque des membres du conseil
                  de discipline sont absents le jour de la réunion, elle est ajournée.
                </li>
                <li>
                  ...
                  de l'institut adresse une 2ème convocation aux membres du conseil de discipline
                  dans un délai de 8 jours. La 2ème réunion se tient quel que soit le nombre de
                  membres présents.
                </li>
                <li>
                ...
                <li>
                  ...
                  conseil de discipline, il est exclu pour la défense d'un étudiant, de faire appel
                  à un élément étranger à l'établissement.
                </li>
                <li>
                  ...
                  lsanction peut être prononcée par défaut lorsque l'étudiant ne se présente pas à
                  la 2ème réunion du conseil de discipline. L'étudiant dispose d'un droit de recours
                  contre ldécision de sanction dans un délai d'un mois suivant la date de
                  notification de la décision.
                </li>
                <li>
                  <strong>Article 28: </strong>Délibération et proposition de sanction: À l'issue
                  des débats, le conseil de discipline délibère, par bulletin secret hors de
                  lprésence des parties concernées, il arrête une proposition de sanction.
                </li>
                <li>
                ...
                <li>
                  ...
                  dossiesi l'infraction est du 2ème degré, et communiquée aux Arrete14
                  établissements d'enseignement supérieur et au COSU dont relève l'étudiant si la
                  sanction est l'exclusion d'amoins une année.
                </li>
                <li>
                ...
                <li>
                  ...
                  adresser un recours légal à l'instance qui a prononcé la sanction. Le recteur ou
                  le directeur de l'INES ou le directeur de l'établissement d'enseignement supérieur
                  ou le directeur de l'institut saisit de nouveau le conseil de discipline.
                </li>
                <li>
                ...
                <li>
                  ...
                  an au minimum qui suit la sanction pour l'avertissement écrit et le blâme et
                  quatre ans pour les exclusions temporaires, l'étudiant peut demander la
                  suppression de l'inscription de la sanction à son dossier. Une demande écrite est
                  adressée au recteur ou au directeur qui tiendra compte du comportement général de
                  l'intéressé depuis la sanction.
                </li>
              </ul>
            </div>
          </div>
