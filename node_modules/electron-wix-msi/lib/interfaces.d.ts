...
export declare type featureAffinity = "main" | "autoUpdate" | "autoLaunch";
...
export declare function isFileComponent(comp: Component | FileComponent): comp is FileComponent;
